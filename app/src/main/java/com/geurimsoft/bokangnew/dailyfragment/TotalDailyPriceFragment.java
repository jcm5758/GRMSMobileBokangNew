...
public class TotalDailyPriceFragment extends Fragment
{
	...
	public TotalDailyPriceFragment() {
	...
	private void setDisplayData(StatsTotalData statsTotalData) {
		...
		this.total_daily_income_title.setText("입고"+"("+statsTotalData.getStock_several()+"대 : "+statsTotalData.getStock_total()+"천원"+")");
		this.total_daily_release_title.setText("출고"+"("+statsTotalData.getRelease_several()+"대 : "+statsTotalData.getRelease_total()+"천원"+")");
		this.total_daily_petosa_title.setText("폐토사"+"("+statsTotalData.getPetosa_several()+"대 : "+statsTotalData.getPetosa_total()+"천원"+")");
	...
	public class DailyPriceTask extends AsyncTask<String, String, StatsTotalData> {
