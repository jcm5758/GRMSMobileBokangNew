...
public class GwangjuMonthPagerFragment extends Fragment {
	...
	private void makeFragmentList(int _userGrade) {
		...
		if(_userGrade <= 1) {
			fragments.add(new GwangjuMonthAmountFragment());
			fragments.add(new GwangjuMonthPriceFragment());
			fragments.add(new GwangjuMonthEnterpriseAmountFragment());
			fragments.add(new GwangjuMonthEnterprisePriceFragment());
			fragments.add(new GwangjuMonthGraphFragment());
		} else {
			fragments.add(new GwangjuMonthAmountFragment());
			fragments.add(new GwangjuMonthEnterpriseAmountFragment());
			fragments.add(new GwangjuMonthGraphFragment());
