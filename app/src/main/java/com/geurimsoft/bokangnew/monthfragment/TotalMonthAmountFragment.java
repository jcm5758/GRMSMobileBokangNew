...
public class TotalMonthAmountFragment extends Fragment {
	
	private ListView tt_month_amount_listview;
	private TextView tt_month_amount_date;
	private String dateStr;
	private LinearLayout tt_month_amount_header_container, tt_month_amount_loading_indicator, tt_month_amount_loading_fail;
	
	private MonthAmountTask monthAmountTask;
	
	public TotalMonthAmountFragment() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View v = inflater.inflate(R.layout.tt_month_amount, container,false);
	...
	public void onResume() {
		...
		this.tt_month_amount_listview = (ListView)view.findViewById(R.id.tt_month_amount_listview);
		this.tt_month_amount_date = (TextView)view.findViewById(R.id.tt_month_amount_date);
				
		this.tt_month_amount_header_container = (LinearLayout)view.findViewById(R.id.tt_month_amount_header_container);
		
		this.tt_month_amount_loading_indicator = (LinearLayout)view.findViewById(R.id.tt_month_amount_loading_indicator);
		this.tt_month_amount_loading_fail = (LinearLayout)view.findViewById(R.id.tt_month_amount_loading_fail);
		
		this.tt_month_amount_listview.setDividerHeight(0);
	...
	private void makeMonthAmountData(int _year, int _monthOfYear) {
		...
		tt_month_amount_date.setText(dateStr);
...
//		tt_month_amount_header_container.removeAllViews();
//
//		StatsHeaderAndFooterView statsHeaderAndFooterView = new StatsHeaderAndFooterView(getActivity(), statsListData);
//		statsHeaderAndFooterView.makeHeaderView(tt_month_amount_header_container);
//
...
//		tt_month_amount_listview.addFooterView(foot);
//
//		tt_month_amount_listview.setAdapter(adapter);
	}
	...
	public class MonthAmountTask extends AsyncTask<String, String, StatsListData> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			tt_month_amount_loading_indicator.setVisibility(View.VISIBLE);
		...
		protected void onPostExecute(StatsListData result) {
			...
			if(result == null) {
				tt_month_amount_loading_fail.setVisibility(View.VISIBLE);
			} else {
				tt_month_amount_loading_fail.setVisibility(View.GONE);
				setDisplay(result);
			}
			
			tt_month_amount_loading_indicator.setVisibility(View.GONE);
		}
	}
}
