...
public class GwangjuYearAmountFragment extends Fragment{

	private ListView gj_year_amount_listview;
	private TextView gj_year_amount_date;
	private String dateStr;
	private LinearLayout gj_year_amount_header_container, gj_year_amount_loading_indicator, gj_year_amount_loading_fail;
	
	private YearAmountTask yearAmountTask;
	
	public GwangjuYearAmountFragment() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View v = inflater.inflate(R.layout.gj_year_amount, container,false);
	...
	public void onResume() {
		...
		this.gj_year_amount_listview = (ListView)view.findViewById(R.id.gj_year_amount_listview);
		this.gj_year_amount_date = (TextView)view.findViewById(R.id.gj_year_amount_date);
				
		this.gj_year_amount_header_container = (LinearLayout)view.findViewById(R.id.gj_year_amount_header_container);
		
		this.gj_year_amount_loading_indicator = (LinearLayout)view.findViewById(R.id.gj_year_amount_loading_indicator);
		this.gj_year_amount_loading_fail = (LinearLayout)view.findViewById(R.id.gj_year_amount_loading_fail);
		
		this.gj_year_amount_listview.setDividerHeight(0);
	...
	private void makeYearAmountData(int _year) {
		...
		gj_year_amount_date.setText(dateStr);
...
//		gj_year_amount_header_container.removeAllViews();
//
//		StatsHeaderAndFooterView statsHeaderAndFooterView = new StatsHeaderAndFooterView(getActivity(), statsListData);
//		statsHeaderAndFooterView.makeHeaderView(gj_year_amount_header_container);
//
...
//		gj_year_amount_listview.addFooterView(foot);
//
//		gj_year_amount_listview.setAdapter(adapter);
	}
	...
	public class YearAmountTask extends AsyncTask<String, String, StatsListData> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			gj_year_amount_loading_indicator.setVisibility(View.VISIBLE);
		...
		protected void onPostExecute(StatsListData result) {
			...
			if(result == null) {
				gj_year_amount_loading_fail.setVisibility(View.VISIBLE);
			} else {
				gj_year_amount_loading_fail.setVisibility(View.GONE);
				setDisplay(result);
			}
			
			gj_year_amount_loading_indicator.setVisibility(View.GONE);
		}
	}
}
