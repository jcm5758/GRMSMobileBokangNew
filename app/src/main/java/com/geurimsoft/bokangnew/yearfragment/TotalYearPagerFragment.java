...
public class TotalYearPagerFragment extends Fragment {
	...
	private void makeFragmentList() {
		...
		fragments.add(new TotalYearAmountFragment());
		fragments.add(new TotalYearPriceFragment());
		fragments.add(new TotalYearGraphFragment());
	}
...
//							calendar.set(Calendar.YEAR, selectYear);
	...
	public class StatsPagerAdapter extends FragmentPagerAdapter {
		...
		public StatsPagerAdapter(FragmentManager fm) {
			...
			super(fm);
			TITLES = getResources().getStringArray(R.array.total_year_tab_array);
