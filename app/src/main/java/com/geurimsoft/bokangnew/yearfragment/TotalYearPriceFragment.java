...
public class TotalYearPriceFragment extends Fragment{

	private ListView tt_year_price_listview;
	private TextView tt_year_price_date;
	private String dateStr;
	private LinearLayout tt_year_price_header_container, tt_year_price_loading_indicator, tt_year_price_loading_fail;
	
	private YearPriceTask yearPriceTask;
	
	public TotalYearPriceFragment() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View v = inflater.inflate(R.layout.tt_year_price, container,false);
	...
	public void onResume() {
		...
		this.tt_year_price_listview = (ListView)view.findViewById(R.id.tt_year_price_listview);
		this.tt_year_price_date = (TextView)view.findViewById(R.id.tt_year_price_date);
				
		this.tt_year_price_header_container = (LinearLayout)view.findViewById(R.id.tt_year_price_header_container);
		
		this.tt_year_price_loading_indicator = (LinearLayout)view.findViewById(R.id.tt_year_price_loading_indicator);
		this.tt_year_price_loading_fail = (LinearLayout)view.findViewById(R.id.tt_year_price_loading_fail);
		
		this.tt_year_price_listview.setDividerHeight(0);
	...
	private void makeYearpriceData(int _year) {
		...
		tt_year_price_date.setText(dateStr);
...
//		tt_year_price_header_container.removeAllViews();
//
//		StatsHeaderAndFooterView statsHeaderAndFooterView = new StatsHeaderAndFooterView(getActivity(), statsListData);
//		statsHeaderAndFooterView.makeHeaderView(tt_year_price_header_container);
//
...
//		tt_year_price_listview.addFooterView(foot);
//
//		tt_year_price_listview.setAdapter(adapter);
	}
	...
	public class YearPriceTask extends AsyncTask<String, String, StatsListData> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			tt_year_price_loading_indicator.setVisibility(View.VISIBLE);
		...
		protected void onPostExecute(StatsListData result) {
			...
			if(result == null) {
				tt_year_price_loading_fail.setVisibility(View.VISIBLE);
			} else {
				tt_year_price_loading_fail.setVisibility(View.GONE);
				setDisplay(result);
			}
			
			tt_year_price_loading_indicator.setVisibility(View.GONE);
		}
	}
}
