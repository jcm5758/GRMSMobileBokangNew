	...
	private static final String DATE_FORMAT = "dd/MM/yyyy";
	    public GraphicalView getView(Context context, List<Result> results) {
	        ...
	        setChartSettings(renderer, 
	        		context.getString(R.string.chartTitle),
	        ...
	        return ChartFactory.getTimeChartView(context, buildDateDataset(title, results), renderer, DATE_FORMAT);
	    ...
	    protected XYMultipleSeriesDataset buildDateDataset(String title, List<Result> results) {
	    ...
	    protected void setRendererProperties(XYMultipleSeriesRenderer renderer, int[] colors,  PointStyle[] styles) {
